...
# %%
CACHE_DIR = Path("cache_offset_metrics_random_effect_penalty")
...
# %%
# metrics + random effects
design_key = make_cache_key(
    "metrics_plus_random_effect_penalty",
    module_names,
    metric_cols,
    metx.shape,
    df_re.shape,
...
for i in range(len(t_end) - 1):
    ...
    step_key = make_cache_key(
        ...
        "design=metrics_free+identity_random_effect_penalized",
        metric_cols,
    )
